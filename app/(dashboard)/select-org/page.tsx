              ...
              <div className="space-y-3">
                {userMemberships?.data?.map((membership) => (
                  <div
                    ...
                    className="border group rounded-lg p-4 hover:bg-blue-50 cursor-pointer transition-colors "
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <ArrowRight className="h-5 w-5 text-gray-400 transition-transform duration-300 group-hover:translate-x-2" />
                    </div>
                  </div>
                ))}
              </div>
